...
<div id="spbellen-block-data">
  <div id="spbellen-stats">
    <div id="spbellen_completed_percentage" style="width:<?php print $stats['no_inactive']['completed_percentage']; ?>%"></div>
    <div id="spbellen_call_back_percentage" style="width:<?php print $stats['no_inactive']['call_back_percentage']; ?>%"></div>
    <div id="spbellen_not_contacted_percentage" style="width:<?php print $stats['no_inactive']['not_contacted_percentage']; ?>%"></div>
    <div id="spbellen_wrong_number_percentage" style="width:<?php print $stats['no_inactive']['wrong_number_percentage']; ?>%"></div>
    <div id="spbellen_blacklisted_percentage" style="width:<?php print $stats['no_inactive']['blacklisted_percentage']; ?>%"></div>
  </div>
